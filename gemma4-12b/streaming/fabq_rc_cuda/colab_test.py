"""FABQ-RC v2 kernel test (Colab cells, .py form).
...
# %%
# Cell 6: verify the extension is importable BEFORE pytest
...
# %%
# Cell 8: bench - decode path (B*T=1)
import torch, time
...
# %%
# Cell 9: bench - batched decode (B*T=16, TC path's target regime)
B, T = 1, 16
