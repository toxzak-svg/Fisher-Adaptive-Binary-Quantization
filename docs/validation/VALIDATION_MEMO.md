...
- `docs/specs/FABQ_RC_SPEC.md` — the four-stage method, target ~1.21 bpw
...
- `docs/specs/FABQ_RC_GGUF_SPEC.md` — 113 lines, two different "GGUF" specs that
...
| `docs/model-cards/MODEL_CARD_HF.md` line 34, 41, 164 | **~1.18** |
| `docs/model-cards/MODEL_CARD.md` (the non-HF one) line 32, 91 | **~1.18** |
| `plans/FABQRC_PLAN.md` line 19 | **~1.18** (target to confirm) |
| `plans/RESEARCH-PLAN.md` line 32 | **~1.18** |
| `docs/specs/FABQ_RC_SPEC.md` line 45, 337, 372 | **~1.21** (with "Corrected bpw math" changelog) |
...
needs to be acknowledged in `docs/specs/FABQ_RC_SPEC.md` and propagated to the
...
cards say:
- `docs/model-cards/MODEL_CARD_HF.md` line 164: `| **FABQ-RC** | ~1.18 | **TBD** | Our method |`
- `plans/FABQRC_PLAN.md` line 27: `### 1.2 Perplexity benchmarks ... **Status:** Model published, validation pending`
...
`docs/specs/FABQ_RC_SPEC.md` line 33-35 says blocksize is per-layer, candidates
...
- `docs/specs/FABQ_RC_GGUF_SPEC.md`: 113 lines, GGML_TYPE_FABQ_RC = 41, single per-layer
...
Walk through the format math in a new section of `docs/specs/FABQ_RC_SPEC.md`
